...
Dump of assembler code for function phase_5:
   ...
   0x000000000040108b <+41>:	movzbl (%rbx,%rax,1),%ecx                             # 对(%rax+%rbx)进行零扩展送到%eax
   ...
   0x0000000000401099 <+55>:	movzbl 0x4024b0(%rdx),%edx                            # 将(%rdx+0x4024b0)对应的值进行32位扩展，放在edx寄存器中
   0x00000000004010a0 <+62>:	mov    %dl,0x10(%rsp,%rax,1)                          # 将dl的值，放进(%rsp+%rax+1)对应的内存地址中
